...
{ .channel_mode = ADC_D_CHANNEL_MODE_SELECT,
  .operation_voltage = ADC_D_VOLTAGE_MODE_NORMAL_1,
  .conversion_clockdiv = ADC_D_CLOCK_DIV_1,
...
{ .clock_settings.comm_rez = IICA_MASTER_COMM_REZ_DISABLED, .clock_settings.digital_filter = 0,
...
uarta_baud_setting_t g_uart0_baud_setting =
{
  ...
  /* Baud rate calculated with Acutal_Error 0.16%. */
...
/* Baud rate calculated with Acutal_Error 0.16%. */
/* The permissible baud rate error range during reception: -4.74% ~ 5.24% */
...
/* Baud rate calculated with Acutal_Error 14.67%. */
/* The permissible baud rate error range during reception: -2.44% ~ 2.56% */
